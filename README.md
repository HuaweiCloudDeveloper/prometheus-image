...
This project offers pre-configured [**`Prometheus-Monitoring and Alarming Tool`**](https://marketplace.huaweicloud.com/intl/hidden/contents/48c73331-f084-4a64-b3f8-565f9bfd478e)，images with Prometheus and its runtime environment pre-installed, along with deployment templates. Follow the guide to enjoy an "out-of-the-box" experience.
